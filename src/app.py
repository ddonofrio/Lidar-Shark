...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.view=ScanView(); layout.addWidget(toolbar); self.config_box=QGroupBox("Source configuration"); self.config_form=QFormLayout(self.config_box); layout.addWidget(self.view,1)
